...
// ● You do not need pre_meshIO.cpp/h. Here's why — consistency:

//   - pre_meshIO depends on geogram + libigl + matfp Logger (lines 10–20 above)
//   - Its functions (normalize_mesh, remove_duplicates, mesh_subdivision, reorder_mesh_from_vector) are only called from
//   load_mesh_and_preprocess — which you're not using
//   - Your project already loads meshes via ObjLoader → MPMesh, which is your consistent pipeline

//   Using pre_meshIO would mean loading the mesh a second time through a completely different path (geogram), diverging from
//    how the rest of the project works.

//   What you actually need from the matfp/ folder:

//   ┌────────────────────────────────┬─────────┬─────────────────────────────────────────┐
//   │              File              │ Needed? │                 Reason                  │
//   ├────────────────────────────────┼─────────┼─────────────────────────────────────────┤
//   │ Args.h                         │ ✓       │ parameter struct for find_feature_edges │
//   ├────────────────────────────────┼─────────┼─────────────────────────────────────────┤
//   │ pre_types.h                    │ ✓       │ Vector3, Vector3i, helper functions     │
//   ├────────────────────────────────┼─────────┼─────────────────────────────────────────┤
//   │ sharp_feature_detection.h/.cpp │ ✓       │ the algorithm                           │
//   ├────────────────────────────────┼─────────┼─────────────────────────────────────────┤
//   │ pre_meshIO.cpp                 │ ✗       │ geogram/libigl dependent, not needed    │
//   ├────────────────────────────────┼─────────┼─────────────────────────────────────────┤
//   │ Logger.h                       │ ✗       │ just replace with fprintf               │
//   └────────────────────────────────┴─────────┴─────────────────────────────────────────┘